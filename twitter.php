 ...
 *  /twitter.php?url='+encodeURIComponent('statuses/user_timeline.json?screen_name=bootstrapmaster&count=2')
*/
 
// The tokens, keys and secrets from the app you created at https://dev.twitter.com/apps
$config = array(
	'oauth_access_token' => '1387635732-A4WPOeQrYHt58JJjvmPaLK13DTBEM9qewPGBUzk',
	'oauth_access_token_secret' => 'mdLJQHeJUFXG1kXHgzaQXilAqkBnP3qNfXZRE4ftgSA',
...
// We'll get the URL from $_GET[]. Make sure the url is url encoded, for example encodeURIComponent('statuses/user_timeline.json?screen_name=bootstrapmaster&count=10&include_rts=false&exclude_replies=true')
if(!isset($_GET['url'])){
	die('No URL set');
}
